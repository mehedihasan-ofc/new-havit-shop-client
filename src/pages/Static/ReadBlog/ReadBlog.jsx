...
const ReadBlog = () => {
    ...
    const { headline, category, readTime, createdAt, image, link, description } = blog;
                    ...
                    <div className="border rounded-md p-4 md:p-10">
                        <div className="space-y-8">
                            <div className="space-y-3 md:space-y-5">
                                <h2 className="text-lg md:text-3xl text-center font-semibold font-serif">{headline}</h2>
                            ...
                            <div className="w-full h-full md:w-[600px] md:h-[315px] mx-auto">
